...
Esse aqui também vai passar com uma condição e vai parar de executar as keywords abaixo!
    ${STATUS}   Run Keyword And Return Status   Should Be True    "Gabriel" == "Gabriel"
    Log  ${STATUS}
    Pass Execution If    ${STATUS}    message=Gabriel é igual a Gabriel, então passou!!

Esse keyword vai passar sozinha!
    Should Be True    "Gabriel" == "Gabriel"

Esse keyword vai falhar sozinha!
    Should Be True    "Gabriel" == "Gabiru"
